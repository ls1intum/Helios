...
1. **How to write a unit test:**: We use Vitest to write unit tests for the client side of the application. Please refer to the documentation [here](https://vitest.dev/docs/getting-started) or look at the examples below.
