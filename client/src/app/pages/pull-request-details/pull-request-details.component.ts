...
@Component({
  ...
  imports: [InputTextModule, CommonModule, RouterLink, TagModule, IconsModule, ButtonModule, PipelineComponent, MarkdownPipe, DeploymentSelectionComponent, SkeletonModule],
