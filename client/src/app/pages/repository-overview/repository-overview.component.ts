...
import {PullRequestBaseInfoDto, RepositoryInfoDto} from '@app/core/modules/openapi';
...
@Component({
  ...
  imports: [DataViewModule, ButtonModule, TagModule, CardModule, ChipModule, IconsModule, PageHeadingComponent, ToastModule, Skeleton, TableModule, InputText, TableFilterComponent, Avatar],
