...
import {
    StatusControllerServiceInterface
} from './status-controller.serviceInterface';
...
export class StatusControllerService implements StatusControllerServiceInterface {
    ...
    public healthCheck(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/status/health`;
