...
export type TagDetailsDto = {
  ...
  markedWorkingBy: Array<UserInfoDto>;
  markedBrokenBy: Array<UserInfoDto>;
...
export type MarkWorkingResponses = {
  /**
   * OK
   */
  200: unknown;
...
export type MarkBrokenResponses = {
  /**
   * OK
   */
  200: unknown;
