...
public class EnvironmentController {
    ...
    public ResponseEntity<List<EnvironmentInfoDTO>> getAllEnvironments() {
        List<EnvironmentInfoDTO> environments = environmentService.getAllEnvironments();
    ...
    @PostMapping()
    public ResponseEntity<EnvironmentInfoDTO> postMethodName(@RequestBody EnvironmentInfoDTO enenvironmentInfoDto) {
        EnvironmentInfoDTO createdEnvironment = environmentService.createEnvironment(enenvironmentInfoDto);
