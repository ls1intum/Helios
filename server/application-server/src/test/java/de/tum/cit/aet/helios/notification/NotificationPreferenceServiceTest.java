...
class NotificationPreferenceServiceTest {
  ...
  void getCurrentUserPreferencesShouldReturnAllPreferences() {
    ...
    List<NotificationPreference> preferences =
        List.of(
            new NotificationPreference(
                testUser, NotificationPreference.Type.DEPLOYMENT_FAILED, true),
    ...
    assertTrue(
        result.stream()
            .anyMatch(
                dto -> dto.type() == NotificationPreference.Type.LOCK_EXPIRED && !dto.enabled()));
  }
  ...
  void updatePreferencesForCurrentUserShouldUpdateExistingPreferences() {
    ...
    List<NotificationPreferenceDto> updateDtos =
        List.of(
