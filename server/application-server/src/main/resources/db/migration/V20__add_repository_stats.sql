...
alter table if exists repository_contributor add constraint FKh74u9ub2ujepmbcquonu82xb2 foreign key (user_id) references public.user;
alter table if exists repository_contributor add constraint FKlrcu5n700fkh90dj34d4rueb9 foreign key (contributor_id) references repository;
