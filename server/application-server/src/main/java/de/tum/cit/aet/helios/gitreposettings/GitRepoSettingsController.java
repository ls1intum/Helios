...
public class GitRepoSettingsController {
    ...
    @GetMapping("/groups")
    public ResponseEntity<List<WorkflowGroupDTO>> getGroupsWithWorkflows(@PathVariable Long repositoryId) {
        List<WorkflowGroupDTO> workflowGroupDTOS = workflowGroupService.getAllWorkflowGroupsByRepositoryId(repositoryId);
    ...
    public ResponseEntity<WorkflowGroupDTO> createWorkflowGroup(
            ...
            @Valid @RequestBody WorkflowGroupDTO workflowGroupDTO) {
        WorkflowGroupDTO createdWorkflowGroup = workflowGroupService.createWorkflowGroup(repositoryId, workflowGroupDTO);
    ...
    public ResponseEntity<Void> updateWorkflowGroups(
            @PathVariable Long repositoryId,
            @Valid @RequestBody List<WorkflowGroupDTO> workflowGroups) {
        workflowGroupService.updateWorkflowGroups(repositoryId, workflowGroups);
        return ResponseEntity.noContent().build();
    }

    @DeleteMapping("/groups/{groupId}")
    public ResponseEntity<Void> deleteWorkflowGroup(@PathVariable Long repositoryId, @PathVariable Long groupId) {
