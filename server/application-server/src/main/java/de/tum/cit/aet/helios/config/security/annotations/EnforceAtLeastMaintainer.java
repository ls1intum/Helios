...
/**
 * This annotation is used to enforce that the user is a maintainer. It should only be used with
 * endpoints starting with {@code /api/}
 *
...
public @interface EnforceAtLeastMaintainer {}
