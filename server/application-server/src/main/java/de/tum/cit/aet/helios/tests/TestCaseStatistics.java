...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          ...
          columnNames = {"test_name", "class_name", "test_suite_name", "branch_name"})
    },
    indexes = {
      @Index(
          name = "idx_test_case_statistics",
          columnList = "test_name,class_name,test_suite_name,branch_name"),
      @Index(name = "idx_branch_name", columnList = "branch_name"),
      @Index(name = "idx_is_flaky", columnList = "branch_name,is_flaky")
    })
@Getter
@Setter
@NoArgsConstructor
