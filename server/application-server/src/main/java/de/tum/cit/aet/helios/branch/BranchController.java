...
public class BranchController {
    ...
    public ResponseEntity<BranchInfoDTO> getBranchByRepositoryIdAndName(@PathVariable Long repoId, @PathVariable String name) {
        return branchService.getBranchInfo(repoId, name)
