...
public class TagController {
  ...
  public ResponseEntity<CommitsSinceTagDto> getCommitsSinceLastTag(@RequestParam String branch) {
    return ResponseEntity.ok(tagService.getCommitsFromBranchSinceLastTag(branch));
  }
